...
public class PasswordGenerator {
  ...
  private static final String PUNCTUATION = "~`!@#$%&*()_-=+{}[]\\:;,./?U+1F4A9";
  ...
  private String selectRestricted(String pool) {
    String selected;
    do {
      int position = rng.nextInt(UPPER_CASE.length());
      selected = UPPER_CASE.substring(position, position + 1);
  ...
  public static class Builder {
    ...
    public Builder allowLowerCase() throws IllegalStateException {
    ...
    public Builder allowDigits() throws IllegalStateException {
    ...
    public Builder allowPunctuation() throws IllegalStateException {
    ...
    public Builder requireUpperCase() throws IllegalStateException {
    ...
    public Builder requireDigits() throws IllegalStateException {
    ...
    public Builder requirePunctuation() throws IllegalStateException {
    ...
    public Builder allowAmbiguous() throws IllegalStateException {
